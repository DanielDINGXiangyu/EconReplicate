...
parameters	
    ...
    psi       = 0.9;                            % Intertemporal Elasticity of Substitution 跨期替代弹性(\psi = 2 or 0.9; See Table 3)
...
% Equation 24-28: Definition of Growth Rate
    ...
    % Equation 26: Definition of Detrended Log Tilde Consumption Growth
        dtc  = dtca+da(-1);
    
    % Equation 27: Definition of Detrended Log Consumption Growth
		dc   = ca-ca(-1)+da(-1);
        
    % Equation 28: Definition of Detrended Log Investment Growth
		di   = ia-ia(-1)+da(-1);
end; 
