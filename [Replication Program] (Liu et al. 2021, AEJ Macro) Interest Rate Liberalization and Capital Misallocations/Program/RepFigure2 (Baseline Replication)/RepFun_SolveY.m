...
Fp_h = RepFun_g(0,ep_h,Ee,sig);
Fp_l = RepFun_g(0,ep_l,Ee,sig);
Fs_h = RepFun_g(0,es_h,Ee,sig);
Fs_l = RepFun_g(0,es_l,Ee,sig);

% Calculate the integral in denominator of (1.24)
Ep_h = RepFun_g(1,ep_h,Ee,sig);
Ep_l = RepFun_g(1,ep_l,Ee,sig);
Es_h = RepFun_g(1,es_h,Ee,sig);
Es_l = RepFun_g(1,es_l,Ee,sig);
